  ...
  cursor delete_object_cur is
          select object_name name, object_type type
           ...
           where object_name in (
                 ...
                 'SCT_UI_ADMIN_SAT', 'SCT_UI_ADMIN_SGR_MAIN', 'SCT_UI_ADMIN_SIF', 'SCT_UI_ADMIN_SGR_RULES', 'SCT_UI_EDIT_GROUP_APEX_ACTION', 
                 'SCT_UI_EDIT_RULE', 'SCT_UI_EDIT_RULE_ACTION', 'SCT_UI_EDIT_SAA', 'SCT_UI_EDIT_SAT', 'SCT_UI_EDIT_SIF', 'SCT_UI_EDIT_SGR', 
                 ...
                 'SCT_UI_LOV_APEX_ACTION_TYPE', 'SCT_UI_LOV_APPLICATIONS', 'SCT_UI_LOV_APP_PAGES', 'SCT_UI_LOV_EXPORT_TYPES', 'SCT_UI_LOV_EXPORT_SAT', 
                 'SCT_UI_LOV_PAGE_ITEMS', 'SCT_UI_LOV_PAGE_ITEMS_P11', 'SCT_UI_LOV_SGR_APPLICATIONS', 'SCT_UI_LOV_PAGE_ITEM_TYPE',
