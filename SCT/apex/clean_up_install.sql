  ...
  cursor delete_object_cur is
          select object_name name, object_type type
           ...
           where object_name in (
                 ...
                 'SCT_UI_EDIT_APEX_ACTION', 'SCT_UI_EDIT_GROUP', 'SCT_UI_EDIT_SGR', 'SCT_UI_EDIT_SAA', 'SCT_UI_EDIT_SGR_APEX_ACTION', 
                 'SCT_UI_EDIT_SRA_COLL', 'SCT_UI_EDIT_SRU_ACTION', 'SCT_UI_EXPORT_SGR_APP', 'SCT_UI_EXPORT_SGR_SGR', 'SCT_UI_LOV_APEX_ACTION_ITEMS',
                 ...
                 'SCT_UI_LOV_SGR_APP_PAGES', 'SCT_UI_LOV_SGR_APPLICATIONS', 'SCT_UI_LOV_SGR_PAGE_ITEMS', 'SCT_UI_LOV_YES_NO', 
                 'SCT_BL_PAGE_ITEMS', 'SCT_BL_SAT_HELP', 'SCT_PARAM_LOV_APEX_ACTION', 'SCT_PARAM_LOV_PAGE_ITEM', 'SCT_PARAM_LOV_PIT_MESSAGE',
                 'SCT_PARAM_LOV_SEQUENCE', -- Views
                 '',   -- Tabellen
                 '',  -- Synonyme
                 '' -- Sequenzen
                 )
