...
begin
  ...
  sct_admin.merge_rule(
    ...
    p_sru_sgr_id => sct_admin.map_id(98),
  ...
  sct_admin.merge_rule_action(
    ...
    p_sra_sgr_id => sct_admin.map_id(98),
  ...
  sct_admin.merge_rule_action(
    ...
    p_sra_sru_id => sct_admin.map_id(108),
    p_sra_sgr_id => sct_admin.map_id(98),
    p_sra_spi_id => 'R6_APEX_ACTION',
  ...
  sct_admin.propagate_rule_change(sct_admin.map_id(98));
