...
begin
  ...
  sct_admin.merge_rule(
    p_sru_id => sct_admin.map_id(257),
    p_sru_sgr_id => sct_admin.map_id(255),
  ...
  sct_admin.merge_rule_action(
    p_sra_id => sct_admin.map_id(259),
    p_sra_sru_id => sct_admin.map_id(257),
    p_sra_sgr_id => sct_admin.map_id(255),
  ...
  sct_admin.merge_rule(
    p_sru_id => sct_admin.map_id(261),
    p_sru_sgr_id => sct_admin.map_id(255),
    p_sru_name => 'Einstellungen geändert',
  ...
  sct_admin.merge_rule_action(
    p_sra_id => sct_admin.map_id(263),
    p_sra_sru_id => sct_admin.map_id(261),
    p_sra_sgr_id => sct_admin.map_id(255),
  ...
  sct_admin.merge_apex_action(    
    p_saa_id => sct_admin.map_id(267),
    p_saa_sgr_id => sct_admin.map_id(255),
    p_saa_sty_id => 'ACTION',
  ...
  sct_admin.merge_apex_action_item(
    p_sai_saa_id => sct_admin.map_id(267),
    p_sai_spi_sgr_id => sct_admin.map_id(255),
    p_sai_spi_id => 'B8_EXPORT',
    p_sai_active => sct_util.C_TRUE);


  sct_admin.propagate_rule_change(sct_admin.map_id(255));
