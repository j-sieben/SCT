...
begin
  ...
  sct_admin.merge_page_item_type(
    ...
    p_sit_include_in_view => sct_util.C_FALSE,
    p_sit_event => 'change',
    p_sit_col_template => q'{sct.get_number('#ITEM#',replace( '#CONVERSION#', 'G')) #ITEM#}',
  ...
  sct_admin.merge_action_item_focus(
    ...
    p_sif_item_types => 'DOCUMENT:ALL:APP_ITEM:BUTTON:DATE_ITEM:ITEM:NUMBER_ITEM:REGION:ELEMENT',
    p_sif_active => sct_util.C_TRUE);

  sct_admin.merge_action_item_focus(
    p_sif_id => 'DATE_ITEM',
    p_sif_name => 'Seitenelement (Datum)',
    p_sif_description => q'{<p>Alle Anwendungs- und Seitenelemente der aktuellen Anwendungsseite mit Datumsformatmasek</p>}',
  ...
  sct_admin.merge_action_item_focus(
    ...
    p_sif_description => q'{<p>Alle Anwendungs- und Seitenelemente der aktuellen Anwendungsseite mit Zahlformatmaske</p>}',
    p_sif_actual_page_only => sct_util.C_TRUE,
  ...
  sct_admin.merge_action_item_focus(
    ...
    p_sif_actual_page_only => sct_util.C_TRUE,
    p_sif_item_types => 'BUTTON:DATE_ITEM:ITEM:NUMBER_ITEM:REGION:ELEMENT',
    p_sif_active => sct_util.C_TRUE);
  ...
  sct_admin.merge_action_item_focus(
    ...
    p_sif_actual_page_only => sct_util.C_TRUE,
    p_sif_item_types => 'DOCUMENT:DATE_ITEM:ITEM:NUMBER_ITEM:ELEMENT',
    p_sif_active => sct_util.C_TRUE);
  ...
  sct_admin.merge_action_type(
    ...
    p_sat_description => q'{<p>Registiert einen APEXAfterRefresh-Eventhandler. Wird das Ereignis ausgelöst, wird dies an SCT gemeldet und kann mit einer Regel AFTER_REFRESH = &lt;Name des Seitenelements&gt; gefangen werden.<br>Auslösendes Element ist das Element, dass in dieser Aktion als FIRING_ITEM registriert wird.</p>}',
    p_sat_pl_sql => q'{}',
    p_sat_js => q'{}',
  ...
  sct_admin.merge_action_type(
    ...
    p_sat_description => q'{<p>Registiert einen DoubleClick-Eventhandler.<br>Wird das Ereignis ausgelöst, wird dies an SCT gemeldet und kann mit einer Regel DOUBLE_CLICK = &lt;Name des Seitenelements&gt; gefangen werden.&nbsp;<br>Auslösendes Element ist das Element, dass in dieser Aktion als FIRING_ITEM registriert wird.</p>}',
    p_sat_pl_sql => q'{}',
    p_sat_js => q'{}',
    p_sat_is_editable => sct_util.C_FALSE,
    p_sat_raise_recursive => sct_util.C_TRUE);
  ...
  sct_admin.merge_action_type(
    ...
    p_sat_description => q'{<p>Registiert einen Enter-Taste-Eventhandler.<br>Wird das Ereignis ausgelöst, wird dies an SCT gemeldet und kann mit einer Regel ENTER_KEY = &lt;Name des Seitenelements&gt; gefangen werden.<br>Auslösendes Element ist das Element, dass in dieser Aktion als FIRING_ITEM registriert wird.</p>}',
    p_sat_pl_sql => q'{}',
    p_sat_js => q'{}',
    p_sat_is_editable => sct_util.C_FALSE,
    p_sat_raise_recursive => sct_util.C_TRUE);
...
q'{}',
  ...
  sct_admin.merge_action_parameter(
    ...
    p_sap_sort_seq => 1,
    p_sap_default => q'{}',
    p_sap_description => q'{<p>PL/SQL-Code, der ausgef&uuml;hrt werden soll.</p>\CR\}' || 
q'{}',
    p_sap_display_name => '',
    p_sap_mandatory => sct_util.C_TRUE,
    p_sap_active => sct_util.C_TRUE);
  ...
  sct_admin.merge_action_parameter(
    ...
    p_sap_sort_seq => 1,
    p_sap_default => q'{}',
    p_sap_description => q'{<p>Wert, der gesetzt werden soll. Es stehen folgende Optionen zur Wahl:</p><ul><li>Konstante Zeichenkette, eingeschlossen in Hochkommata</li><li>JavaScript-Ausdruck, der clientseitig ausgewertet wird</li><li>NULL. In diesem Fall wird der aktuelle Sessionstatuswert des aktualisierten Seitenelements verwendet. Dieser Wert kann durch eine entsprechende Aktion vor Aufruf dieser Methode berechnet worden sein.</li></ul>}',
    p_sap_display_name => '',
    p_sap_mandatory => sct_util.C_FALSE,
    p_sap_active => sct_util.C_TRUE);
  ...
  sct_admin.merge_action_type(
    ...
    p_sat_description => q'{<p>Legt die aktuell ausgewählten Zeilen-IDs im angegebenen Feld ab.</p>}',
    p_sat_pl_sql => q'{}',
  ...
  sct_admin.merge_action_parameter(
    ...
    p_sap_sort_seq => 1,
    p_sap_default => q'{}',
    p_sap_description => q'{<p>Name des Seitenelements, in das die Auswahl des IG gespeichert werden soll.</p>}',
    p_sap_display_name => '',
    p_sap_mandatory => sct_util.C_TRUE,
    p_sap_active => sct_util.C_TRUE);
  ...
  sct_admin.merge_action_parameter(
    ...
    p_sap_sort_seq => 2,
    p_sap_default => q'{1}',
    p_sap_description => q'{<p>1- basierte Ordinalzahl der Spalte, die im hinterlegten Element abgelegt werden soll. Die Reihenfolge richtet sich nach der Reihenfolge auf der APEX-Anwendungsseite.</p>}',
