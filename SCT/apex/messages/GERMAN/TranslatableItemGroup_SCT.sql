...
^'
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_display_name => q'^^',
    p_pti_description => q'^<p>Komma-separierte Liste von Elementnamen oder CSS-Klassen, die die Felder identifizieren, die zu einer Gruppe zusammengefasst werden. Innerhalb dieser Gruppe muss beim Pr&uuml;fen der Werte genau ein Feld einen NOT NULL-Wert besitzen.<br />
Sind alle Elemente NULL oder sind mehr al ein Element NOT NULL, wird ein Fehler geworfen</p>
^'
  );
...
^'
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_display_name => q'^^',
    p_pti_description => q'^<p>Medlungsname, der ausgegeben werden soll, falls die Pr&uuml;fung misslingt. Muss ein PIT-Meldungsname sein, in der Form MSG.&lt;Meldungsname&gt;</p>
^'
  );
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_display_name => q'^^',
    p_pti_description => q'^<p>Sorgt dafür, dass bei einem Klick auf eine Schaltfläche eine Bestätigungsmeldung gezeigt wird.<br>Nur, wenn diese Nachfrage best&auml;tigt wird, wird das Ereignis an SCT gemeldet.</p>^'
  );
...
^'
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_display_name => q'^^',
    p_pti_description => q'^<p>Legt die aktuell ausgew&auml;hlten Zeilen-IDs im angegebenen Feld ab.</p>
^'
  );
