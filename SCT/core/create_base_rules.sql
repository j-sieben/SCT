...
<p><em>Parameter</em>: <span style="font-family:courier new,courier,monospace">REQUEST </span>kann optional &uuml;bergeben werden, ansonsten wird <span style="font-family:courier new,courier,monospace">SUBMIT </span>verwendet.</p>
~',
