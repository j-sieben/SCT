...
as 
   ...
   * %param [p_sgr_with_recursion] Flag, das anzeigt, ob die Regelgruppe Rekursion zulaesst
  ...
  procedure merge_rule_group(
    ...
    p_sgr_with_recursion in sct_rule_group.sgr_with_recursion%type default sct_const.c_false,
   ...
   *                      Standard: FALSE - nur editierbare Aktionstypen werden ausgeliefert
   * %usage  Exportiert alle Aktionstypen, entweder die editierbaren oder die mitgelieferten
   */
   ...
   * %param  p_workspace  Workspace der Anwendung
   ...
   * %usage  Wird aufgerufen, bevor ein Mapping von Primaerschluesselwerten erfolgen soll.
   */
  procedure init_map;
   ...
   * %param  p_sru_fire_on_page_load  Flag, das anzeigt, ob die Regel (zusaetzlich) beim Init der Seite ausgefuehrt wird
   ...
   * %param [p_sra_on_error]        Flag, das anzeigt, ob die Aktivitaet im Fehlerfall der Regel ausgefuehrt werden soll 
   *                                Default: FALSE - Aktivitaet wird nicht im Fehlerfall ausgefuehrt
   * %param [p_sra_raise_recursive] Flag, das anzeigt, ob die Aktivitaet rekursive Aktionen erlauben soll. Default: TRUE
   * %param [p_sra_active]          Flag, das anzeigt, ob die Aktivitaet aktuell verwendet wird.
   * %param [p_comment]             Optionaler (Entwickler-) Kommentar zur Aktion
   * %usage  Wird verwendet, um eine Regelaktivitaet anzulegen
   */
   ...
   * %param  p_sra_spi_id    Referenz auf ein Seitenelement
   * %param  p_sra_sat_id    Referenz auf einen Aktionstyp
   * %param [p_sra_on_error] Flag, das anzeigt, ob die Aktivitaet im Fehlerfall der Regel ausgefuehrt werden soll Default: FALSE
   * %usage  Wird verwendet, um eine Regelaktivitaet zu loeschen
   */
  ...
  procedure merge_action_type(
    ...
    p_sat_pl_sql in sct_action_type.sat_pl_sql%type default null,
    p_sat_js in sct_action_type.sat_js%type default null,
