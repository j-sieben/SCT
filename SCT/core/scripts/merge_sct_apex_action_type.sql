...
using (select 'ACTION' sty_id, 'Befehl/Verweis' sty_display_name, 'JavaScript oder PL/SQL-Befehl, alternativ Verweis' sty_description from dual union all
       select 'TOGGLE', 'Schalter', 'Wahlschalter (JA|NEIN}' from dual union all
       select 'RADIO_GROUP', 'Optionsgruppe', 'Auswahlliste, Optionsfelder' from dual) s
