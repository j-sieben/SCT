...
select sru.sru_id, sru.sru_sgr_id sgr_id, sru.sru_sort_seq, sru.sru_name,
       ...
       sra.sra_spi_id, spi.spi_css item_css, sra.sra_sat_id, sra.sra_param_1, sra.sra_param_2, sra.sra_on_error, sra.sra_sort_seq
 ...
 where sgr.sgr_active = 'Y'
   and sru.sru_active = 'Y'
   and sra.sra_active = 'Y'
   and sra_spi_id != 'ALL'
union all
select sru.sru_id, spi.spi_sgr_id, sru.sru_sort_seq, sru.sru_name,
       ...
       spi.spi_id, spi.spi_css, sra.sra_sat_id, spi.spi_mandatory_message, sra.sra_param_2, sra.sra_on_error, sra.sra_sort_seq
  from sct_rule sru
  join sct_rule_action sra
    on sru.sru_id = sra.sra_sru_id
 cross join sct_page_item spi
 where sru.sru_id = 0
   and spi_is_mandatory = 'Y';
