...
select sru.sru_id, sru.sru_sgr_id sgr_id, sru.sru_sort_seq, sru.sru_name,
       ...
       sra.sra_spi_id, sra.sra_sat_id, sra.sra_attribute, sra.sra_attribute_2, sra.sra_on_error, sra.sra_raise_recursive, sra.sra_sort_seq
...
select sru.sru_id, spi.spi_sgr_id, sru.sru_sort_seq, sru.sru_name,
       ...
       spi.spi_id, sra.sra_sat_id, to_clob(spi.spi_mandatory_message), sra.sra_attribute_2, sra.sra_on_error, sra.sra_raise_recursive, sra.sra_sort_seq
  from sct_rule sru
  join sct_rule_action sra
