...
,p_is_required=>false
,p_default_value=>'de.condes.plugin.sct.apex_42_20_2'
,p_display_length=>40
,p_supported_ui_types=>'DESKTOP:JQM_SMARTPHONE'
,p_is_translatable=>false
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<h2>SCT-APEX functions</h2>',
'<p>This parameter defines the namespace of the JavaScript functionality that is required for the SCT.</p>',
'<p>By default <pre>de.condes.plugin.sct.apex_42_20_2</pre> will be used and supplied with the plugin. The naming scheme refers to theme 42, apex version 20.2.<br>There is also an older version available named <pre>de.condes.plugin.sct.apex_42_5_1</pr'
||'e>.</p>',
'<p>If these functions do not fit the theme you are using, you can create your own copy of this file and customize it.</p>',
'<p>Make sure that the public functions implemented in the supplied sctApex.js file are also present in your implementation.</p>'))
);
wwv_flow_api.create_plugin_attribute(
