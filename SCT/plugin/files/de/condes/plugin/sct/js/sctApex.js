...
(function(sct){
   ...
   * @override
   */
  sct.hideFilterPanel = function(id){
 ...
 * @param {Object} sct Namespace object to adopt SCT to the given APEX version and theme
...
de.condes.plugin.sct.apex_42_20_2 = Object.create(de.condes.plugin.sct.apex_42_5_1);
/**
 * IIFE for Version 18.2, Theme 42
 * @namespace de.condes.plugin.sct.apex_42_20_2
 * @since 5.1
 * @desc
 * 
 * @param {Object} sct Namespace object to adpot SCT to the given APEX version and theme
...
})(de.condes.plugin.sct.apex_20_2, apex.message);